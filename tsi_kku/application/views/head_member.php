<?php $session = $this->session->all_userdata(); // ประกาศsessionเข้าตัวแปร$session 
	  ...
	  // 	print_r($this->session->userdata('no'));
?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<?php 
    ...
    echo link_tag('css/bootstrap-multiselect.css');
...
<div class="ch-container">
    ...
    <div class="col-sm-2 col-lg-2">
        ...
        <div class="nav-canvas">
            ...
            <li><?php echo anchor('quiz/suggestion','<i class="glyphicon glyphicon-home"></i>&nbsp;<span> คำแนะนำ </span>')?></li>
 			<li><?php echo anchor('quiz/start','<i class="glyphicon glyphicon-home"></i>&nbsp;<span> เริ่มทำการทดสอบ </span>')?></li>
			 <li><?php echo anchor('quiz/report','<i class="glyphicon glyphicon-home"></i>&nbsp;<span> สรุปผลคะแนน </span>')?></li>
			 
			 <?php 
			 	$menu  = $this->quiz_model->listCategories();
			 //	print_r($menu);
			 	foreach($menu as $unit){
			 	//	print_r($unit);
			 		echo " <li>";
			 		echo anchor('/question/km/'.$unit["categories_id"],'&nbsp;<i class="fa fa-male"></i>&nbsp; <span> VDO '. $unit["categories_name"].'</span>');
			 		echo "</li>";
			 	}
